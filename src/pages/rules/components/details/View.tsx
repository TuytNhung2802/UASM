...
const View = ({
  ...
  data?: Rule;
  load: () => void;
  setTarget: Dispatch<SetStateAction<Rule | null>>;
}) => {
  const [details, setDetails] = useState<Partial<Rule>>({});
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg rounded-xl w-1/2 p-5">
      <p className="text-center text-blue-500 font-semibold mb-5">Rule</p>
      <div>
